...
{{ Form::model($patientinformation, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('patientinformations.update', $patientinformation->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('patientinformations.show', 'Cancel', $patientinformation->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
